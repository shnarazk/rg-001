    ...
    commands
        ...
        .with_children(|parent| {
            parent.spawn_bundle(ImageBundle {
                ...
                image: asset_server.load("screen.png").into(),
                ..Default::default()
            });
        });
...
fn setup2(mut commands: Commands, mut images: ResMut<Assets<Image>>, asset_server: Res<AssetServer>) {
    ...
    let _image = images.add(image);
    let image = asset_server.load("screen.png");
